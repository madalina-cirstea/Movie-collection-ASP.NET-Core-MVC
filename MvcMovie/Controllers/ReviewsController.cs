...
namespace MvcMovie.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Content,ReviewDate")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Content,ReviewDate")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
